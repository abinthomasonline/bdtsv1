...
DP_TRAIN_DATA_PATH="dataset/dp_train.csv" # training dataset before data pipeline, must keep the exact path
...
TRAIN_DATA_PATH = "datasets/train.csv" # training dataset for training, must keep the exact path
VAL_DATA_PATH = "datasets/val.csv" # validation dataset for training, must keep the exact path
...
train_ts:
	...
	@python main.py -t -l $(LOG_LEVEL) preprocess -v False -c False -d $(DP_TRAIN_DATA_PATH) -p $(DATA_POLICY_PATH) -m $(MODEL_CONFIG_PATH) -o $(DATA_SAVE_PATH)
	@python main.py -t -l $(LOG_LEVEL) preprocess -v True -c False -d $(DP_VAL_DATA_PATH) -p$(DATA_POLICY_PATH) -o $(DATA_SAVE_PATH)
	@python main.py -t -l $(LOG_LEVEL) preprocess -v False -c True -d $(DP_STATIC_COND_PATH) -p$(DATA_POLICY_PATH) -o $(DATA_SAVE_PATH)
